        ...
        const ContactUs = () => {
            ...
            const onSubmit= async(event) =>{
                ...
                formData.append("access_key", "57025b94-feff-4c2f-ab0b-4e6ca87cbafe");
                ...
                const data = await response.json();
                    ...
                    if (data.success) {
                    toast.success('Thank you for your submisssion')
                    event.target.reset();
                    } else {
            ...
            lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white">
                ...
                onSubmit={onSubmit} className="grid sm:grid-cols-2 gap-3 sm:gap-5 max-w-2xl w-full">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <textarea name="message" row={8} placeholder="Enter your messege" className="w-full
